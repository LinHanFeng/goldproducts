...
* git:https://github.com/tianxiangbing/mobile-select-area  2015-09-29 */
var Zepto = function () {
  function a(a) {
  ...
  function c(a) {
    ...
    var t,
        ...
        A = !1;if (e === b && (e = a.fx.speeds._default / 1e3), q === b && (q = 0), a.fx.off && (e = 0), "string" == typeof d) w[k] = d, w[l] = e + "s", w[n] = q + "s", w[m] = o || "linear", z = a.fx.animationEnd;else {
      u = [];for (t in d) {
        r.test(t) ? x += t + "(" + d[t] + ") " : (w[t] = d[t], u.push(c(t)));
      }x && (w[f] = x, u.push(f)), e > 0 && "object" == (typeof d === "undefined" ? "undefined" : _typeof(d)) && (w[g] = u.join(", "), w[h] = e + "s", w[j] = q + "s", w[i] = o || "linear");
    }return _v = function v(b) {
      if ("undefined" != typeof b) {
        if (b.target !== b.currentTarget) return;a(b.target).unbind(z, _v);
      } else a(this).unbind(z, _v);A = !0, a(this).css(s), p && p.call(this);
    }, e > 0 && (this.bind(z, _v), setTimeout(function () {
      A || _v.call(y);
  ...
  function b(c) {
    var d = [["resolve", "done", a.Callbacks({ once: 1, memory: 1 }), "resolved"], ["reject", "fail", a.Callbacks({ once: 1, memory: 1 }), "rejected"], ["notify", "progress", a.Callbacks({ memory: 1 })]],
        ...
        var c = arguments;return b(function (b) {
          a.each(d, function (d, e) {
            var h = a.isFunction(c[d]) && c[d];g[e[1]](function () {
              var c = h && h.apply(this, arguments);if (c && a.isFunction(c.promise)) c.promise().done(b.resolve).fail(b.reject).progress(b.notify);else {
                var d = this === f ? b.promise() : this,
                    g = h ? [c] : arguments;b[e[0] + "With"](d, g);
              }
            });
          }), c = null;
        }).promise();
  ...
  }var c = Array.prototype.slice;a.when = function (d) {
    var e,
        f,
        g,
        h = c.call(arguments),
    ...
    };if (i > 1) for (e = new Array(i), f = new Array(i), g = new Array(i); i > j; ++j) {
  ...
  function b(b) {
    ...
    a = a.replace(/=#\]/g, '="#"]');var c,
        d,
        e = h.exec(a);if (e && e[2] in g && (c = g[e[2]], d = e[3], a = e[1], d)) {
      var f = Number(d);d = isNaN(f) ? d.replace(/^["']|["']$/g, "") : f;
    }return b(a, c, d);
  }var d = a.zepto,
      e = d.qsa,
      f = d.matches,
      g = a.expr[":"] = { visible: function visible() {
      ...
      h = new RegExp("(.*):(\\w+)(?:\\(([^)]+)\\))?$\\s*"),
      i = /^\s*>/,
      j = "Zepto" + +new Date();d.qsa = function (b, f) {
    return c(f, function (c, g, h) {
      try {
        var k;!c && g ? c = "*" : i.test(c) && (k = a(b).addClass(j), c = "." + j + " " + c);var l = e(b, c);
      } catch (m) {
